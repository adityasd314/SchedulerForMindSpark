...
const ENTC = ["ENTC department", Venue.campuses.north,
    buildings(
        ["FOSS LAB"], ["ENTC 1"], ["TEXUS LAB"]

    )];
const BHAU = ["BHAU", Venue.campuses.north,
    buildings(
        ["KIRLOSKAR AUDI"], ["BHAU CR 1"], ["BHAU CR 2"]
